...
public class TitleBar {
	...
	public TitleBar(String homeTeam, String awayTeam, String score,
			String homeTeamImgSrc, String homeTeamImgHt,
			String homeTeamImgWidth, String awayTeamImgSrc,
			String awayTeamImgHt, String awayTeamImgWidth) {
